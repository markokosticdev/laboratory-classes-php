...
if (isset($_SESSION['user'])) {
    ...
    switch ($action) {
        case "assistant-add":
            ...
            <form id="assistant-add" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <label for="status" class="col-xs-12 col-sm-4 col-md-3 col-lg-2 col-form-label">Status</label>
                    <div class="col-xs-12 col-sm-8 col-md-9 col-lg-10">
        ...
        case "assistant-edit":
            ...
            <form id="assistant-edit" enctype="multipart/form-data">
                <div class="form-group row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="form-group row">
                    <label for="assistant"
                           class="col-xs-12 col-sm-4 col-md-3 col-lg-2 col-form-label">Assistant</label>
                    <div class="col-xs-12 col-sm-8 col-md-9 col-lg-10">
                        <select class="form-control" name="assistant" id="assistant">
                            <option value="" disabled="disabled" selected="selected">Choose Assistant</option>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
